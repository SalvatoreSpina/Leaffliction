...
def unzip_and_copy(zip_file, destination):
    ...
    with zipfile.ZipFile(zip_file, 'r') as zip_ref:
        zip_ref.extractall('/tmp/unzipped_DB')  # Temporarily extract files to /tmp
...
def main(zip_file):
    ...
    if user_input == 'y':
        ...
        print(f"Contents of {zip_file} unzipped and copied to {destination_folder}.")
        print("Operation completed successfully! Now you can proceed to predict.py.")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Verify and unzip a zip file if signatures match.")

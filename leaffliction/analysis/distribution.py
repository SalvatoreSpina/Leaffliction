...
def plot_charts(plant_counter, directory_name, save=False, save_path=None):
    ...
    if save:
        pie_chart_path = os.path.join(
            save_path, f'{directory_name}_distribution_pie_chart.png')
    ...
    if save:
        bar_chart_path = os.path.join(
            save_path, f'{directory_name}_distribution_bar_chart.png')
...
if __name__ == "__main__":
    try:
        parser = argparse.ArgumentParser(
            description='Analyze and plot the distribution\
                         of plant images in a directory.')
        parser.add_argument(
            'directory', type=str,
            help='Path to the directory containing plant images.')
        parser.add_argument('--save', action='store_true',
                            help='Flag to save the charts as image files.')
        parser.add_argument('--save_path',
                            type=str,
                            default='.',
                            help='Path to save charts if --save is specified.\
